...
var WorkloadMetrics = class {
	active = zeroRecord(ACTIVE_WORKLOAD_KINDS);
	queueDepth = zeroRecord(QUEUE_WORKLOAD_KINDS);
	queueOldestAgeSeconds = zeroRecord(QUEUE_WORKLOAD_KINDS);
	recoveryBacklog = zeroRecord(RECOVERY_WORKLOAD_KINDS);
	begin(kind) {
...
//#endregion
export { RuntimeObservability, WorkloadMetrics, apply, normalizeMetricsEndpoint };
